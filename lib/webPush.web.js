...
// Clé publique VAPID — définie dans EXPO_PUBLIC_VAPID_PUBLIC_KEY (voir .env.example).
// Publique par nature : la clé privée reste dans les secrets Supabase (VAPID_PRIVATE_KEY).
...
export async function registerWebPush() {
  try {
    ...
    if (!VAPID_PUBLIC_KEY) return; // clé publique absente → pas de subscription
...
// Désabonne le navigateur et supprime la subscription de la DB.
// Appelé à la déconnexion ou quand l'utilisateur révoque les notifications.
